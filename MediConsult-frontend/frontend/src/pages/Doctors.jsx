    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={`flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex' : 'hidden sm:flex'}`}>
          ...
          <p onClick={() => speciality === 'Neurology Specialists' ? navigate('/doctors') : navigate('/doctors/Neurology Specialists')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Neurology Specialists' ? 'bg-[#E2E5FF] text-black ' : ''}`}>Neurology Specialists</p>
          <p onClick={() => speciality === 'Psychiatry Specialists' ? navigate('/doctors') : navigate('/doctors/Psychiatry Specialists')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Psychiatry Specialists' ? 'bg-[#E2E5FF] text-black ' : ''}`}>Psychiatry Specialists</p>
          ...
          <p onClick={() => speciality === 'Urologist' ? navigate('/doctors') : navigate('/doctors/Urologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Urologist' ? 'bg-[#E2E5FF] text-black ' : ''}`}>Urologist</p>
          ...
          <p onClick={() => speciality === 'Radiologist' ? navigate('/doctors') : navigate('/doctors/Radiologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Radiologist' ? 'bg-[#E2E5FF] text-black ' : ''}`}>Radiologist</p>
        </div>
